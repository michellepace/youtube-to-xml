...
- **Migrate all 23 URL-related tests** to use unified CLI:
  ...
  - `tests/test_url_parser.py` (7 tests): Already renamed from `test_url_to_transcript.py`, update imports
- Update `README.md`:
...
3. **Test file already renamed** from `test_url_to_transcript.py` to `test_url_parser.py`
