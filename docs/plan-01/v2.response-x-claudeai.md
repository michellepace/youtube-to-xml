...
- Using clearer field names (`title` instead of `text`)
...
1. 🟡 **`parser.py`** - Incldues 30 tests (exceeds original 11 planned tests), additional refactoring needed. But good for now.
